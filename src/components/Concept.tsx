  ...
  const concepts = [
    {
      ...
      title: t('services.oceantherapy.title'),
      description: t('services.oceantherapy.description')
    },
    {
      icon: (
      ...
      title: t('services.surfing.title'),
      description: t('services.surfing.description')
    },
    {
      icon: (
      ...
      title: t('services.calmness.title'),
      description: t('services.calmness.description')
    },
    {
      icon: (
      ...
      title: t('services.awakening.title'),
      description: t('services.awakening.description')
    },
    {
      icon: (
