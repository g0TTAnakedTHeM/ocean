...
const About = () => {
  return (
    <section id="about" className="apple-section bg-white relative pb-5 mb-[-15px]">
      <div className="absolute inset-0 bg-white"></div>
      
      <div className="apple-container">
        <div className="text-center mb-2 fade-in-section">
          ...
          <p className="apple-text mt-6 mb-4 max-w-3xl mx-auto text-xl md:text-2xl leading-relaxed font-light text-ocean-800">
